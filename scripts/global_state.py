...
cn_preprocessor_modules = {
    ...
    "dw_openpose_mnc": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, fix_neck = True, max_pose_count = 1),
    "dw_openpose_half_body_with_arm": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, fix_neck = True, add_face=True, add_arm=False, add_leg=True, max_pose_count = 1),
    "dw_openpose_half_body_without_arm": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=False, include_face=False, use_dw_pose=True, fix_neck = True, add_face=True, add_arm=True, add_leg=True, max_pose_count = 1),

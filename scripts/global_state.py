...
cn_preprocessor_modules = {
    ...
    "dw_openpose_body": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, max_pose_count = 1, add_pose_default = True),
    "dw_openpose_body2": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, max_pose_count = 0, add_pose_default = False),
    "dw_openpose_mnc": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, fix_neck = True, max_pose_count = 1, add_pose_default = True),
    "dw_openpose_half_body_with_arm": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=True, include_face=False, use_dw_pose=True, fix_neck = True, add_face=True, add_arm=False, add_leg=True, max_pose_count = 1, add_pose_default = True),
    "dw_openpose_half_body_without_arm": functools.partial(g_openpose_model.run_model, include_body=True, include_hand=False, include_face=False, use_dw_pose=True, fix_neck = True, add_face=True, add_arm=True, add_leg=True, max_pose_count = 1, add_pose_default = True),
...
cn_preprocessor_unloadable = {
    ...
    "ip-adapter_clip_sd15": functools.partial(not_unload_clip, config='clip_h'),
    "ip-adapter_clip_sdxl_plus_vith": functools.partial(not_unload_clip, config='clip_h'),
    "ip-adapter_face_id_plus": functools.partial(not_unload_clip, config='clip_h'),
    ...
    "dw_openpose_body2": g_openpose_model.unload,
    "dw_openpose_mnc": g_openpose_model.unload,
